...
class BKViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.array[0].setting = BKSetting(selectedSize: CGSize(width: 10, height: 10),
                                          selectedRadius: 0,
                                          ...
                                          animationTime: 0.2,
                                          minimumSpace: 0);
        self.array[1].setting = BKSetting(selectedSize: CGSize(width: 20, height: 20),
                                          selectedRadius: 0,
                                          selectedOffSet: UIOffset(horizontal: 0, vertical: 0),
                                          selectedColor: #colorLiteral(red: 0.4156862745, green: 0.3725490196, blue: 0.9725490196, alpha: 1),
                                          normalSize: CGSize(width: 10, height: 10),
                                          ...
                                          animationTime: 0.2,
                                          minimumSpace: 10);
        self.array[2].setting = BKSetting(selectedSize: CGSize(width: 20, height: 20),
                                          selectedRadius: 0,
                                          ...
                                          animationTime: 0.2,
                                          minimumSpace: 10);
        self.array[3].setting = BKSetting(selectedSize: CGSize(width: 10, height: 10),
                                          selectedRadius: 5,
                                          selectedOffSet: UIOffset(horizontal: 0, vertical: 0),
                                          selectedColor: #colorLiteral(red: 0.4156862745, green: 0.3725490196, blue: 0.9725490196, alpha: 1),
                                          normalSize: CGSize(width: 10, height: 10),
                                          ...
                                          animationTime: 0.2,
                                          minimumSpace: 5);
        self.array[4].setting = BKSetting(selectedSize: CGSize(width: 20, height: 10),
                                          selectedRadius: 5,
                                          selectedOffSet: UIOffset(horizontal: 0, vertical: 0),
                                          ...
                                          animationTime: 0.2,
                                          minimumSpace: 5);
        self.array[5].setting = BKSetting(selectedSize: CGSize(width: 10, height: 10),
                                          selectedRadius: 5,
                                          selectedOffSet: UIOffset(horizontal: 0, vertical: 0),
                                          selectedColor: #colorLiteral(red: 0.1960784346, green: 0.3411764801, blue: 0.1019607857, alpha: 1),
                                          ...
                                          animationTime: 0.2,
                                          minimumSpace: 5);
        self.array[6].setting = BKSetting(selectedSize: CGSize(width: 20, height: 20),
                                          selectedRadius: 10,
                                          ...
                                          animationTime: 0.2,
                                          minimumSpace: 5);
        self.array[7].setting = BKSetting(selectedSize: CGSize(width: 4, height: 4),
                                          selectedRadius: 2,
                                          selectedOffSet: UIOffset(horizontal: 0, vertical: 0),
                                          selectedColor: #colorLiteral(red: 0.1960784346, green: 0.3411764801, blue: 0.1019607857, alpha: 1),
                                          ...
                                          animationTime: 0.2,
                                          minimumSpace: 5);
        self.array[8].setting = BKSetting(selectedSize: CGSize(width: 10, height: 30),
                                          selectedRadius: 0,
                                          selectedOffSet: UIOffset(horizontal: 0, vertical: 0),
                                          selectedColor: #colorLiteral(red: 0.1960784346, green: 0.3411764801, blue: 0.1019607857, alpha: 1),
                                          normalSize: CGSize(width: 10, height: 10),
                                          ...
                                          animationTime: 0.2,
                                          minimumSpace: 5);
        self.array[9].setting = BKSetting(selectedSize: CGSize(width: 10, height: 30),
                                          selectedRadius: 5,
                                          selectedOffSet: UIOffset(horizontal: 0, vertical: 0),
                                          ...
                                          animationTime: 0.2,
                                          minimumSpace: 5);
        self.array[10].setting = BKSetting(selectedSize: CGSize(width: 10, height: 30),
                                           selectedRadius: 5,
                                           selectedOffSet: UIOffset(horizontal: 0, vertical: 0),
                                           selectedColor: #colorLiteral(red: 0.9254902005, green: 0.2352941185, blue: 0.1019607857, alpha: 1),
                                           normalSize: CGSize(width: 10, height: 10),
